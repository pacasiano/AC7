        ...
        <div className="header">
            ...
            <div className="flex relative justify-between items-stretch bg-gray-100 text-md">
                <div className="flex jusitfy-evenly gap-4 pl-3 font-bold md:visible invisible">
                    <button onClick={MenuDropdown} className="flex items-center m-0 visible md:invisible md:pl-0 pl-2"><FontAwesomeIcon icon={faBars} style={{color: "#000000",}} /></button>
                ...
                <div id="menuButton" className="absolute hidden md:hidden bg-slate-50 z-10 pl-5 p-1 w-full top-12">
                    <div className="flex justify-start gap-5">
                        <CustomLink href="/" className="flex items-center m-0 font-bold" >Menu</CustomLink>
                        <CustomLink href="/Store" className="flex items-center m-0 font-bold">Store</CustomLink>
                        <CustomLink href="/About" className="flex items-center m-0 font-bold">About</CustomLink>
                    </div>
                </div>
                <div className="flex jusitfy-evenly gap-7 pr-7 -ml-[90%]">
                    <div className="relative lg:visible collapse">
                    ...
                    <div id="userDropdown" className="hidden z-50 absolute right-2 mt-14 w-44 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5">
