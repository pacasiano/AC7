        ...
        <div className="footer">
            ...
            <div className="flex justify-between items-stretch bg-gray-100 h-24 text-md">
                <div className="flex justify-start gap-4 pl-8 font-bold">
                    ...
                    <div className="flex items-center m-0">Facebook Logo</div>
                    <div className="flex items-center m-0">Shopee Logo</div>
                </div>
                <div className="flex jusitfy-evenly gap-4 pr-8 font-bold">
                    <div className="flex flex-col justify-center pr-7 gap-1 text-xs">
                        ...
                        <div className="flex items-center m-0"><FontAwesomeIcon icon={faPhone} style={{color: "#000000",}} />&nbsp;Phone</div>
                        <div className="flex items-center m-0"><FontAwesomeIcon icon={faEnvelope} style={{color: "#000000",}} />&nbsp;Email</div>
                    </div>
