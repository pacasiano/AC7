  ...
  return (
    <div className="bg-gray-100 p-5 gap-5 flex flex-col">
      ...
      <div className="flex flex-row gap-2 w-full">
        ...
        <button onClick={cancelOrder} disabled={sale_status !== 'packaging'} className={`${sale_status !== 'packaging' ? "bg-neutral-50 text-gray-500" : "bg-black/10" } transition-all ${sale_status === 'packaging' && "hover:bg-black/20"} p-2 rounded-md w-full font-medium`}>Cancel order</button>
        )}
