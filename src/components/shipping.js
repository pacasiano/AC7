                    ...
                    <table className="w-full border-collapse border">
                        <thead>
                            <tr className="bg-gray-400">
                                <th className="text-sm font-semibold border p-2 text-white">Shipment ID</th>
                                <th className="text-sm font-semibold border p-2 text-white">Purchase ID</th>
                                <th className="text-sm font-semibold border p-2 text-white">Address</th>
                                <th className="text-sm font-semibold border p-2 text-white">Tracking Number</th>
                                <th className="text-sm font-semibold border p-2 text-white">Courier</th>
                                <th className="text-sm font-semibold border p-2 text-white">Date Sent</th>
                                <th className="text-sm font-semibold border p-2 text-white">Date Received</th>
