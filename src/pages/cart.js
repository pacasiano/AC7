        ...
        <div className="flex flex-col lg:w-1/2 w-11/12 gap-5 ">
          <div className="bg-gray-100 p-5">
            ...
            <div className="flex flex-row justify-evenly lg:-mx-20 -mx-5">
              <div className=""><input type="checkbox" /> All</div>
      ...
      <div className="bg-gray-100 p-5">
        <div className="flex flex-row justify-evenly gap-5">
          ...
          <div className="lg:w-36 md:w-32 w-28 flex-shrink-0">
            <img src={Item1} className="object-fill resize-none rounded-md w-36" alt="Item1" />
          </div>
          <div className="flex flex-col  w-2/4">
            <div className="flex justify-start text-xl font-bold lg:pt-5 pt-0 pb-2 ">{name}</div>
            <div className="flex flex-row justify-evenly lg:gap-10 gap-0">
              <div className="relative flex flex-col justify-center gap-3">
                <div className="flex justify-end lg:text-md font-medium text-sm">$100.00</div>
              ...
              <div className="flex flex-row items-center justify-center lg:w-24 w-16 pb-1 ">
                <button
                  ...
                  className="flex justify-center m-0 mt-1 p-1 w-1/3 align-middle lg:text-md text-xs hover:font-extrabold ">-</button>
                <div className="flex justify-center m-0 pt-2 p-1 lg:w-1/3 w-1/5 lg:text-md text-sm font-semibold ">{quantity}</div>
                <button
