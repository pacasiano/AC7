          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" action="#">
              <div>
                ...
                <input type="email" name="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-gray-500 focus:border-gray-500 block w-full p-2.5"
              ...
              <p className="text-sm font-light text-gray-500">
                ...
                <a href="/Login" className="font-medium text-blue-400 hover:underline">Login here</a>
              </p>
            </form>
          </div>
        </div>
